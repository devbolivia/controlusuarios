          ...
          <div class="large-12 columns">
            ...
            <div class="callout panel">
              <div class="row">
                ...
                <h4>Editar comerciante</h4>

              </div>
              <?php echo form_open('comerciantes/procesarEditarComerciante/'.$id); ?>
                  ...
                  <div class="small-12 large-8">
                    ...
                    <div class="row">
                      ...
                      <div class="small-8 columns">
                        <input name="ncaseta" value="<?php echo set_value('ncaseta', $numero); ?>" type="text" id="right-label" placeholder="Ingrese el numero de caseta">
                      </div>
                    </div>
                    <div class="row">
                      <div class="small-4 columns">
                      ...
                      <div class="small-8 columns">
                        <input name="nombres" value="<?php echo set_value('nombres', $nombres); ?>" type="text" id="right-label" placeholder="Ingrese sus nombre">
                      </div>
                    </div>
                    <div class="row">
                      <div class="small-4 columns">
                      ...
                      <div class="small-8 columns">
                        <input name="apellidos" value="<?php echo set_value('apellidos', $apellidos); ?>" type="text" id="right-label" placeholder="Ingrese sus apellidos">
                      </div>
                    </div>
                    <div class="row">
                      <div class="small-4 columns">
                      ...
                      <div class="small-8 columns">
                        <input name="codigo" value="<?php echo set_value('codigo', $codigo); ?>" type="text" id="right-label" placeholder="Ingrese su codigo de afiliado">
                      </div>
                    </div>
                    <div class="row">
                      <div class="small-4 columns">
                      ...
                      <div class="small-8 columns">
                        <input name="carnet" value="<?php echo set_value('carnet', $carnet); ?>" type="text" id="right-label" placeholder="Ingrese su carnet">
                      </div>
                    </div>
                    <div class="row">
                      <div class="small-4 columns">
                      ...
                      <div class="small-8 columns">
                        <input name="direccion" value="<?php echo set_value('direccion', $direccion); ?>" type="text" id="right-label" placeholder="Ingrese la direccion">
                      </div>
                    </div>
                    <div class="row">
                      <div class="small-4 columns">
                    ...
                    <div class="row">
                      ...
                      <div class="small-8 columns">
                        <textarea name="observacion"><?php echo set_value('observacion', $observaciones); ?></textarea>
                      </div>
                    </div>
                    <div class="row">
